module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        "atlacolormarble-white": "var(--atlacolormarble-white)",
      ...
      fontFamily: {
        "web-desktop-body-normal": "var(--web-desktop-body-normal-font-family)",
        "web-desktop-body-small": "var(--web-desktop-body-small-font-family)",
        "web-desktop-h3": "var(--web-desktop-h3-font-family)",
        sans: [
          "ui-sans-serif",
          "system-ui",
          "sans-serif",
