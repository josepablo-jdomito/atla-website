...
export function ProgressiveBlur({
  ...
  return (
    <div
      className={cn(
        "gradient-blur pointer-events-none inset-x-0 z-10",
        anchored ? "absolute" : "",
        className,
        position === "top"
          ? "top-0"
      ...
      style={{
        ...
        background:
          position === "bottom"
            ? "linear-gradient(to bottom, rgba(255,255,255,0) 0%, rgba(255,255,255,0.06) 60%, rgba(255,255,255,0.14) 100%)"
            : position === "top"
              ? "linear-gradient(to top, rgba(255,255,255,0) 0%, rgba(255,255,255,0.06) 60%, rgba(255,255,255,0.14) 100%)"
              : "linear-gradient(to bottom, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.04) 12%, rgba(255,255,255,0.04) 88%, rgba(255,255,255,0.12) 100%)",
      }}
    >
