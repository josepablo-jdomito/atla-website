# Atla Static Site Copy

This document captures the hardcoded text currently present in the site codebase.

Excluded on purpose:
- Sanity-driven portfolio content
...
### SEO title
- `Services — Atla Design Studio`

### SEO description
- `Brand strategy, identity design, digital design, and creative direction for companies that take their brand seriously.`
...
Static labels only. Dynamic project content is excluded.
...
Static copy only. Article/category content is excluded.
...
Static labels only. Article content is excluded.
